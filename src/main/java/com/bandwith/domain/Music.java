...
public class Music {
    ...
    public Music(int music_id, String title, byte musicProfileImage, String singer, String composer) {
    ...
    public static Music of(MusicDto musicDto){
        return new Music(musicDto.getMusic_id(), musicDto.getTitle(), musicDto.getMusicProfileImage(), musicDto.getComposer(),musicDto.getSinger());
    }
